    ...
    variants: {
      size: {
        ...
        lg: [
          ...
          'group-[.button--group]:focus-visible:rounded-sm',
          'group-[.button--group]:first:focus-visible:rounded-l-lg',
          'group-[.button--group]:last:focus-visible:rounded-r-lg',
        ],
        xl: [
          'px-4',
          'h-12',
      ...
      intent: {
        ...
        brand: [
          // Solid
          'data-[variant=solid]:bg-brand',
          'data-[variant=solid]:text-white',
          'data-[variant=solid]:border-brand',
          'data-[variant=solid]:hover:text-brand',
          'data-[variant=solid]:hover:bg-transparent',
        ],
      },
      disabled: {
